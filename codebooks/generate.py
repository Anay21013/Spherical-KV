...
def main():
    print("=" * 70)
    print("Spherical KV Codebook Training -- POST-RoPE K capture")
    ...
    print(f"Step 4/4  Fitting {total_fits} codebooks in '{KMEANS_MODE}' mode ...\n")
    ...
    print("\nCodebook quality (POST-RoPE training):")
